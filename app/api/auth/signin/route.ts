...
import { AuthError, safeReturnPath, sameOriginRequest, sessionCookie, signInWithPassword, type D1DatabaseLike } from "../../../../lib/password-auth";
...
export async function POST(request: Request) {
  ...
  try {
    const session = await signInWithPassword(db, {
